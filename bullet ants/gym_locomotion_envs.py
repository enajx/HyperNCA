...
from robot_locomotors import AntSmall, AntBig, AntAsymFront, AntAsymCross
...
class AntBulletSmallEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = AntSmall()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)

class AntBulletBigEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = AntBig()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)

class AntBulletAsymFrontEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = AntAsymFront()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)

class AntBulletAsymCrossEnv(WalkerBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = AntAsymCross()
    WalkerBaseBulletEnv.__init__(self, self.robot, render)
