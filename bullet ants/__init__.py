...
register(id='AntBulletBigEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:AntBulletBigEnv',
         max_episode_steps=1000,
         reward_threshold=2500.0)

register(id='AntBulletSmallEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:AntBulletSmallEnv',
         max_episode_steps=1000,
         reward_threshold=2500.0)

register(id='AntBulletAsymCrossEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:AntBulletAsymCrossEnv',
         max_episode_steps=1000,
         reward_threshold=2500.0)

register(id='AntBulletAsymFrontEnv-v0',
         entry_point='pybullet_envs.gym_locomotion_envs:AntBulletAsymFrontEnv',
         max_episode_steps=1000,
         reward_threshold=2500.0)
